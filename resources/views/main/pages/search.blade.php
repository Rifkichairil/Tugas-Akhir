                        ...
                        <div class="text-center">
                            ...
                            <form action="" method="get">
                                <div class="input-group mb-3 pb-1">
                                    <input class="form-control text-1" placeholder="Search..." name="q" id="q" type="search" value="{{ request('q') }}">
...
<section>
    <div class="container py-2">
        <h4 class="text-dark" style="padding-bottom: 20px">Hasil Pencarian Bahan dari :<strong> {{$q}} </strong></h4>
            ...
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" >
                <div class="card" style="background-color: #f7f7f7">
                    ...
                    <div class="card-body">
                        ...
                        {{-- <h4 class="card-title mb-1 pb-3 text-4 font-weight-bold">Score {{ $recipe['_score']}}</h4> --}}
                        {{-- <button class="btn btn-xs btn-success"><i class="fe-heart"></i> {{ $recipe['_score']}} </button> --}}
                        {{-- <a href="{{ route('main.detail', [$recipe['_source']['id']]) }}" class="btn btn-xs btn-success"> {{$recipe['_source']['id']}}</i></a> --}}
